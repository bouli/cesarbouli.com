<?php
$meta_image = "http://cesarbouli.com/images/como-se-fosse-a-ultima-vez/photo.jpg";
$meta_text = "Lan";
$meta_title = "Cesar Bouli - Como Se Fosse A Última Vez";
$root_url = "http://cesarbouli.com";
?><!DOCTYPE html>
<html lang="es">
<head>
	<script>
	window.location.replace("https://www.youtube.com/watch?v=dQZYDKcQiEU");
	</script>
	...
	<meta property="og:url" content="http://cesarbouli.com/como-se-fosse-a-ultima-vez">
